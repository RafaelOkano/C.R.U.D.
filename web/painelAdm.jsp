    ...
    <body>
        ...
        <main class="d-flex flex-column align-items-center">
            <form class="d-flex mt-4" role="search">
                <input class="form-control me-2" type="text" placeholder="Search" aria-label="Search" name="txtName">
                ...
                <tbody>
                    <%
                        ...
                        while (rs.next()) {
                            ...
                            out.print("<td><a href='excluirUsuario.jsp?id=" + rs.getString(1) + "'><img src='imagens/excluir.png'></a></td>");
                            out.print("<td><a href='alterarUsuario.jsp?id=" + rs.getString(1) + "'><img src='imagens/editar-arquivo.png'></a></td>");
                            out.print("</tr>");
                        }
                    %>
                </tbody>
            ...
            <p class="d-flex flex-row justify-content-center mt-4">
                <a class="btn btn-primary" href="adicionarUsuario.jsp" role="button">Adicionar Usuário</a>
            </p>
        </main>
