            ...
            <section class="vh-100 bg-image"
                                    ...
                                    <div class="card-body p-5">
                                        ...
                                        <form method="post">
                                            ...
                                            <div data-mdb-input-init class="form-outline mb-4">
                                                <input type="text" id="form3Example1cg" class="form-control form-control-lg" name="txtNome" value="<%= rs.getString(2)%>"/>
                                                <label class="form-label" for="form3Example1cg">Nome do curso: </label>
                                            </div>

                                            <div data-mdb-input-init class="form-outline mb-4">
                                                <input type="text" id="form3Example3cg" class="form-control form-control-lg" name="txtDescricao" value="<%= rs.getString(3)%>"/>
                                                <label class="form-label" for="form3Example3cg">Descrição: </label>
                                            </div>

                                            <div data-mdb-input-init class="form-outline mb-4">
                                                <input type="text" id="form3Example4cg" class="form-control form-control-lg" name="txtCargaHoraria" value="<%= rs.getString(4)%>"/>
                                                <label class="form-label" for="form3Example4cg">Carga Horária: </label>
                                            </div>

                                            <div class="d-flex justify-content-center">
                                                <button  type="submit" data-mdb-button-init name="botaoCadastrar"
                ...
                <% }
                    if (request.getParameter("botaoCadastrar") != null) {
                        ...
                        st.executeUpdate("UPDATE curso SET nomeCurso='" + nomeVar + "', descricao='" + descricaoVar + "', cargaHoraria='" + cargaHorariaVar + "' where idCurso='" + idCurso + "'");
                %>
                <script>
